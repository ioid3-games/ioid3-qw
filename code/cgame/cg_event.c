...
//			trap_S_StartSound(NULL, es->number, CHAN_AUTO, cgs.media.noAmmoSound);
		...
		case EV_FOOTSTEP_HARD_FROZEN:
			...
			if (cg_footsteps.integer) {
				trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_HARD_FROZEN][rand()&7]);
			}
		...
		case EV_FOOTSTEP_HARD_SLUSH:
			...
			if (cg_footsteps.integer) {
				trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_HARD_SLUSH][rand()&7]);
			}
		...
		case EV_FOOTSTEP_HARD_SNOW:
			...
			if (cg_footsteps.integer) {
				trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_HARD_SNOW][rand()&7]);
			}
		...
		case EV_FOOTSTEP_PUDDLE:
			...
			if (cg_footsteps.integer) {
				trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_PUDDLE][rand()&7]);
			}
		...
		case EV_FOOTSTEP_BUSH:
			...
			if (cg_footsteps.integer) {
				switch (ci->foottype) {
					default:
					case FOOTTYPE_DEFAULT:
						trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_BUSH][rand()&7]);
						break;
					case FOOTTYPE_BOOT_01:
					case FOOTTYPE_BOOT_02:
					case FOOTTYPE_BOOT_03:
						trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_BOOT_01_BUSH][rand()&7]);
						break;
				}
			}
		...
		case EV_FOOTSTEP_GRASS:
			...
			if (cg_footsteps.integer) {
				trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_GRASS][rand()&7]);
			}
		...
		case EV_FOOTSTEP_LONGGRASS:
			...
			if (cg_footsteps.integer) {
				trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_LONGGRASS][rand()&7]);
			}
		...
		case EV_FOOTSTEP_SAND:
			...
			if (cg_footsteps.integer) {
				trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_SAND][rand()&7]);
			}
		...
		case EV_FOOTSTEP_MUD:
			...
			if (cg_footsteps.integer) {
				trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_MUD][rand()&7]);
			}
		...
		case EV_FOOTSTEP_ICE:
			...
			if (cg_footsteps.integer) {
				trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_ICE][rand()&7]);
			}
		...
		case EV_FOOTSTEP_GRATE_01:
			...
			if (cg_footsteps.integer) {
				trap_S_StartSound(NULL, es->number, CHAN_BODY, cgs.media.footsteps8[FOOTSTEP_DEFAULT_GRATE_01][rand()&7]);
			}
