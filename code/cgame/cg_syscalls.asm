...
equ trap_Cvar_VariableStringBuffer			-35
equ trap_FS_FOpenFile						-36
equ trap_FS_Read							-37
equ trap_FS_Write							-38
equ trap_FS_Seek							-39
equ trap_FS_FCloseFile						-40
equ trap_PC_AddGlobalDefine					-41
equ trap_PC_LoadSource						-42
equ trap_PC_FreeSource						-43
equ trap_PC_ReadToken						-44
equ trap_PC_SourceFileAndLine				-45
