...
equ trap_R_AddPolyToScene					-313
equ trap_R_AddPolysToScene					-314
equ trap_R_LightForPoint					-315
equ trap_R_AddLightToScene					-316
equ trap_R_AddAdditiveLightToScene			-317
equ trap_R_ModelBounds						-318
equ trap_R_LerpTag							-319
equ trap_R_DrawStretchPic					-320
equ trap_R_RemapShader						-321
