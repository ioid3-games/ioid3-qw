...
equ trap_Argc								-26
equ trap_Argv								-27
equ trap_SendConsoleCommand					-28
equ trap_Cvar_Register						-29
equ trap_Cvar_Update						-30
equ trap_Cvar_Set							-31
equ trap_Cvar_VariableIntegerValue			-32
equ trap_Cvar_VariableStringBuffer			-33
equ trap_FS_FOpenFile						-34
equ trap_FS_Read							-35
equ trap_FS_Write							-36
equ trap_FS_Seek							-37
equ trap_FS_FCloseFile						-38
equ trap_FS_GetFileList						-39
equ trap_PC_AddGlobalDefine					-40
equ trap_PC_LoadSource						-41
equ trap_PC_FreeSource						-42
equ trap_PC_ReadToken						-43
equ trap_PC_SourceFileAndLine				-44
