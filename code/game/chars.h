...
#define CHARACTERISTIC_AIM_SKILL_MISSILELAUNCHER	34 // float [0, 1]
// accuracy when aiming
#define CHARACTERISTIC_AIM_ACCURACY					35 // float [0, 1]
// weapon specific aim accuracy
#define CHARACTERISTIC_AIM_ACCURACY_HANDGUN			36 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_MACHINEGUN		37 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_H_MACHINEGUN	38 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		39 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_SHOTGUN			40 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_NAILGUN			41 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_PHOSPHORGUN		42 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_PROXLAUNCHER	43 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_GRENADELAUNCHER	44 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_NAPALMLAUNCHER	45 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_ROCKETLAUNCHER	46 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_BEAMGUN			47 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_RAILGUN			48 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_PLASMAGUN		49 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_BFG10K			50 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_MISSILELAUNCHER	51 // float [0, 1]
// how much the bot fires its weapon (continuous or bursts)
#define CHARACTERISTIC_FIRETHROTTLE					52 // float [0, 1]
#define CHARACTERISTIC_LEADER_STRATEGY				53 // integer [1, 4]
//=====================================================================================================================================
// CHAT
//=====================================================================================================================================
// tendency to insult/praise
#define CHARACTERISTIC_CHAT_INSULT					54 // float [0, 1]
// tendency to chat about miscellaneous subject
#define CHARACTERISTIC_CHAT_MISC					55 // float [0, 1]
// tendency to chat at start or end of level
#define CHARACTERISTIC_CHAT_STARTENDLEVEL			56 // float [0, 1]
// tendency to chat entering or exiting the game
#define CHARACTERISTIC_CHAT_ENTEREXITGAME			57 // float [0, 1]
// tendency to chat when the character killed someone
#define CHARACTERISTIC_CHAT_KILL					58 // float [0, 1]
// tendency to chat when the character died
#define CHARACTERISTIC_CHAT_DEATH					59 // float [0, 1]
// tendency to chat when enemy commits suicide
#define CHARACTERISTIC_CHAT_ENEMYSUICIDE			60 // float [0, 1]
// tendency to chat when hit while chatting
#define CHARACTERISTIC_CHAT_HITTALKING				61 // float [0, 1]
// tendency to chat when bot was hit but didn't die
#define CHARACTERISTIC_CHAT_HITNODEATH				62 // float [0, 1]
// tendency to chat when bot hit the enemy but enemy didn't die
#define CHARACTERISTIC_CHAT_HITNOKILL				63 // float [0, 1]
// tendency to chat at random moments
#define CHARACTERISTIC_CHAT_RANDOM					64 // float [0, 1]
// tendency to reply to chats
#define CHARACTERISTIC_CHAT_REPLY					65 // float [0, 1]
