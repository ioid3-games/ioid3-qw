...
void AAS_JumpReachRunStart(aas_reachability_t *reach, vec3_t runstart) {
	...
	// movement prediction
	AAS_PredictClientMovement(&move, -1, start, PRESENCE_NORMAL, qtrue, vec3_origin, cmdmove, 1, 2, 0.1f, SE_HITGROUNDDAMAGE|SE_ENTERWATER|SE_ENTERLAVA|SE_ENTERSLIME|SE_GAP, 0, qfalse);
